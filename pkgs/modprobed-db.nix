# https://github.com/archseer/snowflake/blob/fc2f3e90f7777b5238d80be7c8f0942b416de6d1/pkgs/misc/modprobed-db.nix
# Modified to fix user services paths
{
  lib,
  stdenv,
  fetchFromGitHub,
...
stdenv.mkDerivation rec {
  ...
  postPatch = ''
    substituteInPlace ./Makefile --replace "/usr/lib" "/lib"
    substituteInPlace ./common/modprobed-db.in --replace "/usr/share" "$out/share"
    substituteInPlace ./init/modprobed-db.service --replace "/usr/bin" "$out/bin"
  '';
