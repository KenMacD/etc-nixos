...
# TODO: remove once nixos-unstable hits 0.0.14 (needed for https://github.com/QwenLM/qwen-code/pull/713)
buildNpmPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-ibHIp3H00fcDGQ7QddzEI3Huqbpk11JKiFbMifmiEdM=";
  };
  ...
  npmDepsHash = "sha256-UlvlN4zkfWZv+Nbt1RYp6usSAX8n+ekJAtbk0O9hT1o=";
  ...
  postPatch = ''
    ...
    substituteInPlace packages/core/src/tools/ripGrep.ts \
      --replace-fail "const { rgPath } = await import('@lvce-editor/ripgrep');" \
      "const rgPath = 'rg';"
