...
# Borrowed from: https://github.com/shiryel/fennecOS/blob/71f0abacb376c2560d7a15d5c71162c5d70a1c6d/lib/opensnitch.nix
# Set times to EPOCH to match normal NixOS dates
